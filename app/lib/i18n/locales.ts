...
export const messages: Record<LocaleKey, { vi: string; en: string }> = {
  ...
  'market.title': { vi: 'Tín hiệu thị trường', en: 'Market Signals' },
  'market.subtitle': {
    vi: 'Xác suất đồng thuận chỉ để tham khảo phân tích.',
    en: 'Consensus probability for analytical context only.',
  },
  'market.disclaimer': {
    vi: 'Tín hiệu thị trường chỉ nhằm mục đích tham khảo phân tích, không phải lời khuyên đặt cược.',
    en: 'Market signals are shown for analytical context only and are not betting advice.',
  },
  'market.loading': { vi: 'Đang tải tín hiệu thị trường…', en: 'Loading market signals…' },
  'market.empty': {
  ...
  'market.volatility': { vi: 'Tín hiệu biến động', en: 'Volatility signal' },
  'market.chartTitle': { vi: 'Mô hình so với thị trường', en: 'Model vs market' },
  ...
  'matchAnalysis.marketNote': {
    vi: 'Tín hiệu thị trường (nếu có) chỉ để so sánh phân tích với mô hình.',
    en: 'Market signals (if any) are for analytical comparison with the model only.',
  },
