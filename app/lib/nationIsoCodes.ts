/** ISO 3166-1 alpha-2 codes for all 48 WC 2026 nations — keep in sync with scripts/nationIsoCodes.mjs */
export const NATION_ISO: Record<string, { iso: string; short: string }> = {
...
export function nationMeta(nation: string): { iso: string; short: string } {
