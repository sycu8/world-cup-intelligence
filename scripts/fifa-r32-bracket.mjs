 ...
 * Keep in sync with src/services/fifaR32Bracket.ts
 * @see https://en.wikipedia.org/wiki/2026_FIFA_World_Cup_knockout_stage
 */

/** @typedef {{ kind: 'group_rank'; group: string; rank: 1 | 2 | 3 } | { kind: 'third_place'; group: string }} R32SlotRule */

/** @typedef {{ matchId: string; fifaNumber: number; home: R32SlotRule; away: R32SlotRule }} R32MatchSlot */

/** @type {R32MatchSlot[]} */
export const FIFA_R32_MATCH_SLOTS = [
